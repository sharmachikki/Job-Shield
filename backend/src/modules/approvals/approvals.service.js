const repository = require('./approvals.repository');
const AppError = require('../../utils/AppError');

// Business logic for "approvals" lives here. Controllers stay thin; this is where
...
async function getById(id) {
  ...
  if (!record) throw new AppError('Approvals not found', 404);
  return record;
}
