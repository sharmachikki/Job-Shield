const repository = require('./vendors.repository');
const AppError = require('../../utils/AppError');

// Business logic for "vendors" lives here. Controllers stay thin; this is where
...
async function getById(id) {
  ...
  if (!record) throw new AppError('Vendors not found', 404);
  return record;
}
