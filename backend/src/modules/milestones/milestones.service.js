const repository = require('./milestones.repository');
const AppError = require('../../utils/AppError');

// Business logic for "milestones" lives here. Controllers stay thin; this is where
...
async function getById(id) {
  ...
  if (!record) throw new AppError('Milestones not found', 404);
  return record;
}
