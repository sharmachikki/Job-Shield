const repository = require('./invoices.repository');
const AppError = require('../../utils/AppError');

// Business logic for "invoices" lives here. Controllers stay thin; this is where
...
async function getById(id) {
  ...
  if (!record) throw new AppError('Invoices not found', 404);
  return record;
}
