const repository = require('./requirements.repository');
const AppError = require('../../utils/AppError');

// Business logic for "requirements" lives here. Controllers stay thin; this is where
...
async function getById(id) {
  ...
  if (!record) throw new AppError('Requirements not found', 404);
  return record;
}
