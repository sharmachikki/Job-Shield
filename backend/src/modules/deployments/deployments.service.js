const repository = require('./deployments.repository');
const AppError = require('../../utils/AppError');

// Business logic for "deployments" lives here. Controllers stay thin; this is where
...
async function getById(id) {
  ...
  if (!record) throw new AppError('Deployments not found', 404);
  return record;
}
