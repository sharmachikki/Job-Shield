const repository = require('./employers.repository');
const AppError = require('../../utils/AppError');

// Business logic for "employers" lives here. Controllers stay thin; this is where
...
async function getById(id) {
  ...
  if (!record) throw new AppError('Employers not found', 404);
  return record;
}
