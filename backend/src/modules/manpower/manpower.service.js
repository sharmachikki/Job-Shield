const repository = require('./manpower.repository');
const AppError = require('../../utils/AppError');

// Business logic for "manpower" lives here. Controllers stay thin; this is where
...
async function getById(id) {
  ...
  if (!record) throw new AppError('Manpower not found', 404);
  return record;
}
