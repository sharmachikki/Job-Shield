const repository = require('./freelancers.repository');
const AppError = require('../../utils/AppError');

// Business logic for "freelancers" lives here. Controllers stay thin; this is where
...
async function getById(id) {
  ...
  if (!record) throw new AppError('Freelancers not found', 404);
  return record;
}
