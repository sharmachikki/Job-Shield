const repository = require('./candidates.repository');
const AppError = require('../../utils/AppError');

// Business logic for "candidates" lives here. Controllers stay thin; this is where
...
async function getById(id) {
  ...
  if (!record) throw new AppError('Candidates not found', 404);
  return record;
}
